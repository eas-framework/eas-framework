require('source-map-support').install();module.exports = (_require, _include, _transfer, private_var, handelConnector) => {
  return async function(page) {
    ...
    {
      try {
        run_script_name = `WWW/index.page -> Models/Website.mode`;
        run_script_code = `
    const declareVariable = 9;
`;
        //!WWW/index.page<line>/Users/idoio/Documents/beyond-easy/tests/core/Website/Models/Website.mode:2:30
        const declareVariable = 9;
        out_run_script.text += `
<!DOCTYPE html>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    `;
        run_script_name = `WWW/index.page -> Components/NavLink.inte`;
        run_script_code = `{`;
        //!WWW/index.page<line>/Users/idoio/Documents/beyond-easy/tests/core/Website/Components/NavLink.inte:1:3
        {
          out_run_script.text += `
...
<li class="nav-item">
    <a class="nav-link" href="/">Home</a>
          ...
          run_script_code = `}`;
          //!WWW/index.page<line>/Users/idoio/Documents/beyond-easy/tests/core/Website/Components/NavLink.inte:5:8
        }
        out_run_script.text += `
                    `;
        run_script_name = `WWW/index.page -> Components/NavLink.inte`;
...
<div class="markdown-body"><h1 id="welcome-to-eas-testing-website" tabindex="-1"><a class="header-anchor" href="#welcome-to-eas-testing-website">Welcome to EAS Testing Website</a></h1>
<p>Testings Types:</p>
<ul>
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,