module.exports = (_require, _include, _transfer, private_var, handelConnector)=>{
    return async function(page) {
        ...
        ;
        {
            ...
            out_run_script.text += ` </ul> <form class="d-flex"> <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search"/> <button class="btn btn-outline-success" type="submit"> Search </button> </form> </div> </div> </nav> <main class="flex-shrink-0 pt-5"> <div class="container mt-5"> <nav aria-label="breadcrumb"> <ol class="breadcrumb"> <li class="breadcrumb-item"> <a href="/"> Home </a> </li> <li class="breadcrumb-item"> <a href="/static/index"> Static </a> </li> <li class="breadcrumb-item active" aria-current="page"> Svelte SSR </li> </ol> </nav> <hr/> <div id="c3RhdGljL3"> <main> <div class="counter svelte-1i3xkcf"> <p class="svelte-1i3xkcf"> Counte: 5 </p> <button class="svelte-1i3xkcf"> + </button> </div> <div class="number-color svelte-eyttln"> <p style="font-size:16px"> This number: 0.949 </p> </div> 
    {
  &quot;max&quot;: 100,
  &quot;current&quot;: 5
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbIi4uLy4uLy4uLy4uLy4uL3Rlc3RzL2NvcmUvV2Vic2l0ZS9Nb2RlbHMvV2Vic2l0ZS5tb2RlLnRzIl0sIm5hbWVzIjpbXSwibWFwcGluZ3MiOiI7Ozs7Ozs7Ozs7Ozs7QUFBQTtBQUFBO0FBQUEiLCJmaWxlIjoic3NyLnBhZ2UuY2pzIn0=