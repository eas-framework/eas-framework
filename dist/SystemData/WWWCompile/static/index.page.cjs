module.exports = (_require, _include, _transfer, private_var, handelConnector)=>{
    return async function(page) {
        const __filename = "/Users/idoio/Documents/beyond-easy/tests/core/Website/WWW/static/index.page", __dirname = "/Users/idoio/Documents/beyond-easy/tests/core/Website/WWW/static";
        ...
        ;
        {
            ...
            out_run_script.text += ` </ul> <form class="d-flex"> <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search"/> <button class="btn btn-outline-success" type="submit"> Search </button> </form> </div> </div> </nav> <main class="flex-shrink-0 pt-5"> <div class="container mt-5"> <nav aria-label="breadcrumb"> <ol class="breadcrumb"> <li class="breadcrumb-item"> <a href="/"> Home </a> </li> <li class="breadcrumb-item"> <a href="/static/index"> Static </a> </li> <li class="breadcrumb-item active" aria-current="page"> Index </li> </ol> </nav> <hr/> <div class="markdown-body"><ul>
<li><a href="./svelte/index">Svelte</a></li>
<li><a href="./svelte/ssr">Svelte SSR</a></li>
<li><a href="./typescript/index">TypeScript</a></li>
