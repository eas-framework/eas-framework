module.exports = (_require, _include, _transfer, private_var, handelConnector)=>{
    return async function(page) {
        const __filename = "/Users/idoio/Documents/beyond-easy/tests/core/Website/WWW/compile/index.page", __dirname = "/Users/idoio/Documents/beyond-easy/tests/core/Website/WWW/compile";
        ...
        ;
        {
            ...
            out_run_script.text += ` </ul> <form class="d-flex"> <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search"/> <button class="btn btn-outline-success" type="submit"> Search </button> </form> </div> </div> </nav> <main class="flex-shrink-0 pt-5"> <div class="container mt-5"> <nav aria-label="breadcrumb"> <ol class="breadcrumb"> <li class="breadcrumb-item"> <a href="/"> Home </a> </li> <li class="breadcrumb-item"> <a href="/compile/index"> Compile </a> </li> <li class="breadcrumb-item active" aria-current="page"> Index </li> </ol> </nav> <hr/> <div class="markdown-body"><ul>
<li><a href="./record/index">Record</a></li>
<li><a href="./runtime/index">Runtime</a></li>
<li><a href="./runtime/more_compile/index">More Runtime</a></li>
<li><a href="./search/index">Search</a></li>
<li><a href="./search/searchbox">Search Box</a></li>
<li><a href="./search_runtime/index">Search Runtime</a></li>
<li><a href="./sass/index">Sass</a></li>
<li><a href="./error/index">Error</a></li>
<li><a href="./import_page/index">Import Page</a></li>
<li><a href="./import_extension/index">Import Extension</a></li>
<li><a href="./md/index">Markdown</a></li>
</ul>
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbIi4uLy4uLy4uLy4uL3Rlc3RzL2NvcmUvV2Vic2l0ZS9Nb2RlbHMvV2Vic2l0ZS5tb2RlLnRzIl0sIm5hbWVzIjpbXSwibWFwcGluZ3MiOiI7Ozs7Ozs7Ozs7Ozs7QUFBQTtBQUFBO0FBQUEiLCJmaWxlIjoiaW5kZXgucGFnZS5janMifQ==