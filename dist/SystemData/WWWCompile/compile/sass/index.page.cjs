require('source-map-support').install();module.exports = (_require, _include, _transfer, private_var, handelConnector) => {
  return async function(page) {
    ...
    {
      try {
        run_script_name = `WWW/compile/sass/index.page -> WWW/compile/server.mode -> Models/TestBreadcrumb.mode -> Models/Website.mode`;
...
<link rel="stylesheet" href="/V1dXL.pub.css"/></head>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    `;
        run_script_name = `WWW/compile/sass/index.page -> Components/NavLink.inte`;
        out_run_script.text += `
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Sass</li>
    </ol>
</nav>
<hr/>
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,