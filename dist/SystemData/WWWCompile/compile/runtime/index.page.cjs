module.exports = (_require, _include, _transfer, private_var, handelConnector)=>{
    return async function(page) {
        ...
        ;
        {
            ...
            out_run_script.text += ` </ul> <form class="d-flex"> <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search"/> <button class="btn btn-outline-success" type="submit"> Search </button> </form> </div> </div> </nav> <main class="flex-shrink-0 pt-5"> <div class="container mt-5"> <nav aria-label="breadcrumb"> <ol class="breadcrumb"> <li class="breadcrumb-item"> <a href="/"> Home </a> </li> <li class="breadcrumb-item"> <a href="/compile/index"> Compile </a> </li> <li class="breadcrumb-item active" aria-current="page"> Runtime </li> </ol> </nav> <hr/> /Users/idoio/Documents/beyond-easy/tests/core/Website/WWW/compile/runtime <br/> /Users/idoio/Documents/beyond-easy/tests/core/Website/WWW/compile/runtime/index.page <br/> /Users/idoio/Documents/beyond-easy/tests/core/Website/WWW/compile/runtime <br/> /Users/idoio/Documents/beyond-easy/tests/core/Website/WWW/compile/runtime/index.page <br/> /compile/runtime/index <br/> <br/> <h2> Inside Sample: </h2> `;
            {
                out_run_script.text += ` <p> This cool </p> /Users/idoio/Documents/beyond-easy/tests/core/Website/WWW/compile/runtime <br/> /Users/idoio/Documents/beyond-easy/tests/core/Website/WWW/compile/runtime/Sample.inte <br/> /Users/idoio/Documents/beyond-easy/tests/core/Website/WWW/compile/runtime <br/> /Users/idoio/Documents/beyond-easy/tests/core/Website/WWW/compile/runtime/index.page <br/> /compile/runtime/index <br/> {
  "atrOne": "thisValue",
  "thisTrue": true,
