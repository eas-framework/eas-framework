module.exports = (_require, _include, _transfer, private_var, handelConnector)=>{
    return async function(page) {
        ...
        ;
        {
            ...
            if (Post?.connectorFormCall == "dda03e6c-7490-450b-a83d-12915b12e4bd") {
    ...
    <input type="hidden" name="connectorFormCall" value="dda03e6c-7490-450b-a83d-12915b12e4bd"/> <input type="email" name="email" placeholder="Email" value="`;
            write(Post.email);
