require('source-map-support').install();module.exports = (__dirname, __filename, _require, _include, private_var, handelConnector) => {
...
`;
//!WWW/about.page -> WWW/nested.mode<line>Models/Website.mode:1:3
...
<html lang="en" me=more>
    ...
    <link rel="stylesheet" href="/serv/markdown-theme/atom-one-light.css"/><script src="/about-YWJvd.pub.js" defer></script></head>
    <body>
        <header>
...
<p>Today date: `;
run_script_code=`writeSafe((new Date().toString()));`;
//!WWW/about.page:11:40
writeSafe((new Date().toString()));
out_run_script.text+=`</p>
`;
run_script_code=`writeSafe(me);`;
//!WWW/about.page:12:4
writeSafe(me);
out_run_script.text+=`
...
run_script_name=`WWW/about.page`;{run_script_code=`run_script_name=\`WWW/about.page -> Components/ButtonLink.inte\`;`;
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,