require('source-map-support').install();module.exports = (_require, _include, _transfer, private_var, handelConnector) => {
  return async function(page) {
    ...
    {
      try {
        run_script_name = `Logs/e404.page -> Models/Website.mode`;
        run_script_code = `
    const declareVariable = 9;
`;
        //!Logs/e404.page<line>/Users/idoio/Documents/beyond-easy/tests/core/Website/Models/Website.mode:2:30
        const declareVariable = 9;
        out_run_script.text += `
<!DOCTYPE html>
...
<link rel="stylesheet" href="/TG9nc.pub.css?t=l"/></head>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    `;
        run_script_name = `Logs/e404.page -> Components/NavLink.inte`;
        run_script_code = `{`;
        //!Logs/e404.page<line>/Users/idoio/Documents/beyond-easy/tests/core/Website/Components/NavLink.inte:1:3
        {
          out_run_script.text += `
...
<li class="nav-item">
    <a class="nav-link" href="/">Home</a>
          ...
          run_script_code = `}`;
          //!Logs/e404.page<line>/Users/idoio/Documents/beyond-easy/tests/core/Website/Components/NavLink.inte:5:8
        }
        out_run_script.text += `
                    `;
        run_script_name = `Logs/e404.page -> Components/NavLink.inte`;
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,