module.exports = (_require, _include, _transfer, private_var, handelConnector)=>{
    return async function(page) {
        const __filename = "/Users/idoio/Documents/beyond-easy/tests/core/Website/Logs/e500.page", __dirname = "/Users/idoio/Documents/beyond-easy/tests/core/Website/Logs";
        ...
        ;
        {
            ...
            out_run_script.text += ` </ul> <form class="d-flex"> <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search"/> <button class="btn btn-outline-success" type="submit"> Search </button> </form> </div> </div> </nav> <main class="flex-shrink-0 pt-5"> <div class="container mt-5"> <h1> Error compiling the page </h1> 
`;
            write(Request.error);
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,