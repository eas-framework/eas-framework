...
import { getTypes, BasicSettings } from '../../RunTimeBuild/SearchFileSystem.js';
...
import { createImporter, sassStyle, sassSyntax } from '../../BuildInComponents/Components/style/sass.js';
...
export async function registerExtension(filePath, smallPath, dependenceObject, isDebug) {
    ...
    const context = await preprocess(filePath, smallPath, dependenceObject, (importPath) => {
