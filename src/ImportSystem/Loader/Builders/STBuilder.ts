...
import {TranspilerTemplate, transpileStringTracker} from "./BaseBuilders.js";
import IBuilder from "./IBuilder.js";

export default class STBuilder extends IBuilder<any> {
    private readonly typeScriptAlwaysTrue: boolean;
    private readonly template?: TranspilerTemplate;
