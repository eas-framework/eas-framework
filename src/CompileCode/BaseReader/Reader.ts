...
// import exportsAsModule from '../../../../../asemblyCompiler/index';
// import {setReader, BaseReader, InsertComponentBase} from '../../../../../asemblyCompiler/src/BaseScriptReader';
// // import fs from 'fs';

// // const wasmModule = assemblyscript.instantiateSync(fs.readFileSync(__dirname + '/../../../../../asemblyCompiler/build/untouched.wasm'), {});

// setReader(exportsAsModule);

// export {BaseReader, InsertComponentBase}
import StringTracker from '../../EasyDebug/StringTracker';
import {insert_component, find_end_of_def, find_end_of_q, get_errors, find_close_char, find_close_char_html_elem, attribute} from './RustBind/index.js';
...
export class InsertComponentBase extends BaseReader {
    private printNew: any;
    private tree_map: number[] = [];
    private SimpleSkip_: string[];
    private SkipSpecialTag_: string[][];

    constructor(printNew:any = null, SimpleSkip = ['textarea','script', 'style'], SkipSpecialTag = [["%", "%"], ["#{debug}", "{debug}#"]]){
        super();
    ...
    FindSpecialTagByStart(string: StringTracker) {
    ...
    FindCloseChar2(text: StringTracker, Search: string, Open = "<", End = ">", CharBeforeEnd = '/', TypeAsEndBigTag = false) {
        const SkipTypes = ['"', "'", '`'];
        let i = 0;
    ...
    private printErrors(text: StringTracker){
    ...
    public FindCloseChar(text: StringTracker, Search: string, Open = "<", End = ">", CharBeforeEnd = '/', TypeAsEndBigTag = false): number{
    ...
    public FindCloseCharHTML(text: StringTracker, Search: string){
