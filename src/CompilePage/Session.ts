...
import { StringAnyMap, StringNumberMap } from "../Settings/types"
import { safeDebug } from "../Settings/utils"
import SourceMapTracker from "../SourceTracker/SourceMap/SourceMapTracker"
import StringTracker from "../SourceTracker/StringTracker/StringTracker"
import { shortNames } from "../Storage/StaticStorage"
...
export class SessionBuild {
    ...
    dependencies: DepCreator = MPages.createSession()
    recordNames: string[] = []
